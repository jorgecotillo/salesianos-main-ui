...
var auth_service_1 = require("./components/shared/services/auth.service");
var global_events_manager_1 = require("./components/shared/services/global.events.manager");
var auth_guard_service_1 = require("./components/shared/services/auth-guard.service");
    ...
    core_1.NgModule({
        ...
        imports: [
            ...
            router_1.RouterModule.forRoot([
                ...
                { path: 'counter', component: counter_component_1.CounterComponent, canActivate: [auth_guard_service_1.AuthGuardService] },
